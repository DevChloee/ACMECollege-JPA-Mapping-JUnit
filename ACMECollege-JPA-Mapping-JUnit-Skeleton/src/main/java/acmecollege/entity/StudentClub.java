...
@DiscriminatorColumn(discriminatorType=DiscriminatorType.INTEGER, name="academic", length=1, columnDefinition="BIT(1)")
public abstract class StudentClub extends PojoBase implements Serializable {
    ...
    @OneToMany(cascade=CascadeType.MERGE, fetch = FetchType.LAZY, mappedBy = "club")
